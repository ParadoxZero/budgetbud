...
export class AddCategoriesForm extends React.Component<
  EditCategoriesFormProps,
  EditCategoriesFormState
> {
  ...
  render_add_category() {
    ...
    const onFinish = (values: any) => {
      ...
      this.data_service
        .createCategories(this.props.budget_id, category_list)
        .then((value: Budget) => {
      ...
      >
        <Form.List name="categories">
          {(fields, { add, remove }) => (
            ...
            >
              {fields.map((field) => (
                <Flex gap={5} justify="center" align="center" key={field.key}>
                  <Form.Item
