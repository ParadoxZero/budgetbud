  ...
  render() {
    return (
      <>
        ...
        <LinkBudgetModal
          isOpen={this.state.is_link_modal_open}
    ...
    return (
      ...
      >
        <Form.Item<FieldType>
          ...
          name="name"
          rules={[
            { required: true, message: "Please enter a name for the budget" },
          ]}
        >
          <Input />
        </Form.Item>
        ...
        <Form.Item>
          <Button
            ...
            icon={<LinkOutlined />}
            onClick={() => {
              this.setState({ is_link_modal_open: true });
            }}
          >
            Add Existing Budget
          </Button>
