...
export function LinkBudgetModal(props: {
  isOpen: boolean;
  onDone: () => void;
  onClose: () => void;
}) {
  ...
  const handle_ok = () => {
    ...
    const code = (document.getElementById("share_code_id") as HTMLInputElement)
      .value;
    if (code.length == 0) {
      ...
      <Modal
        ...
        footer={
          <Flex style={{ width: "100%" }} align="center" justify="center">
            <Button type="primary" size="large" onClick={handle_ok}>
              Ok
            </Button>
          </Flex>
        }
      ...
      >
        <Flex vertical align="center" justify="center">
          <Typography.Paragraph>
            Linking budget will allow you to share the budget with others.
          </Typography.Paragraph>
          <Input
            id="share_code_id"
            size="large"
